...
ActiveRecord::Schema[7.2].define(version: 2026_01_15_120000) do
  ...
  create_table "coinstats_accounts", id: :uuid, default: -> { "gen_random_uuid()" }, force: :cascade do |t|
    ...
    t.string "address"
    t.string "blockchain"
    t.index ["coinstats_item_id", "account_id", "address", "blockchain"], name: "index_coinstats_accounts_on_item_token_and_wallet", unique: true, where: "((account_id IS NOT NULL) AND (address IS NOT NULL) AND (blockchain IS NOT NULL))"
